---
title: "03 - Accéder à la gestion des unités de formation"
description: ""
date: "2025-09-01"
version: "1"
---
...
![Accès au menu unités de formation](placeholder-menu-acces-unites-formation.png "Navigation principale vers les unités de formation")
...
- **Approbation** : Permission "Approbation des unités de formation"
...
La page principale présente un tableau récapitulatif de toutes les unités de formation avec :

- **Dénomination sociale** et nom commercial
- **SIRET** et statut de conformité
- **État** actuel (Active, Inactive, etc.)
- **Lieux de formation** rattachés
- **Actions disponibles** selon vos permissions

![Liste des unités de formation](placeholder-liste-unites-formation.png "Vue d'ensemble des unités de formation")
...
![Barre de recherche unités](placeholder-recherche-unites.png "Outils de recherche")
...
![Accès module approbation](placeholder-acces-approbations.png "Navigation vers les approbations")
...
![Bouton création unité](placeholder-bouton-creer-unite.png "Point d'entrée création")

### Pour aller plus loin
-> [04 - Création d'une unité de formation](04-creation-unite-formation)