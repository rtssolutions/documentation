...
La gestion des apprenants est accessible depuis le menu principal de Papaours, dans la section **"Apprenants"**,
sous-menu **"liste"**.

![Menu d'accès aux apprenants](https://papaours.s3.fr-par.scw.cloud/documentations/tutoriel/apprenant/3/menu-apprenant.png "259×397")

### Permissions d'accès

Pour accéder au module, vous devez disposer au minimum de la permission **"Lecture des apprenants"**. Les
fonctionnalités disponibles dépendront de vos permissions spécifiques :

- **Consulter** : Permission "Lecture des apprenants"
...
![Tableau d'accueil des apprenants](https://papaours.s3.fr-par.scw.cloud/documentations/tutoriel/apprenant/3/liste-apprenant.png)
...
![Barre de recherche](https://papaours.s3.fr-par.scw.cloud/documentations/tutoriel/apprenant/3/rechercher-apprenant.png)
...
-> [04 - Création d'un apprenant](04-creation-apprenant)